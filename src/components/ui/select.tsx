...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      "relative flex w-full cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-amber-50 focus:text-amber-900 hover:bg-amber-50 hover:text-amber-900 data-[disabled]:pointer-events-none data-[disabled]:opacity-50 bg-white text-gray-900",
      className
    )}
    {...props}
  >
